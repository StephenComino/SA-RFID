...
class MFRC522:
    ...
    def MFRC522_DumpClassic1K(self, key, uid, Start=0, End=4):
        for i in range(Start,End):
            ...
            if status == self.OK:                    
                ...
                #keys = [[0x00,0x00,0x00,0x00,0x00,0x02], [0x00,0x00,0x00,0x00,0x00,0x0A], [0x00,0x00,0x00,0x00,0x00,0x0B], [0x10,0x00,0x00,0x00,0x00,0x00], [0x20,0x00,0x00,0x00,0x00,0x00], [0xA0,0x00,0x00,0x00,0x00,0x00], [0xB0,0x00,0x00,0x00,0x00,0x00]]
                print("Authentication error2")
                #return None
    def MFRC522_DumpClassic1K2(self, key, uid, Start=4, End=56):
        for i in range(Start,End):
            status = self.auth(self.AUTHENT1A, i, key, uid)
            # Check if authenticated
            print("")
            ...
            if status == self.OK:                    
                ...
                print("Authentication error2")
                #return None
    def MFRC522_DumpClassic1K3(self, key, uid, Start=56, End=60):
            for i in range(Start,End):
                status = self.auth(self.AUTHENT1A, i, key, uid)
                # Check if authenticated
                print("")
                ...
                if status == self.OK:                    
                    ...
                    print("Authentication error2")
                    return None
    def MFRC522_DumpClassic1K4(self, key, uid, Start=60, End=64):
            for i in range(Start,End):
                status = self.auth(self.AUTHENT1A, i, key, uid)
                # Check if authenticated
                print("")
                ...
                if status == self.OK:                    
                    ...
                    print("Authentication error2")
                    return None
    def MFRC522_Write(self, key, uid, Start=4, End=56):
        data = []
        for x in range(0,16):
            data.append(0x32)
       
        status = self.auth(self.AUTHENT1A, 1, key, uid)
            # Check if authenticated
        print("")
        print("{:02d}: ".format(8),end="")
        if status == self.OK:                    
            block = self.write(1, data)
        else:
            print("Authentication error3")
